    ...
    public static void refreshRoles() {
        for (Role role : WatheRoles.ROLES) {
            ...
            if (!ModdedWeights.roleRounds.containsKey(role)) {
                ...
                Log.info(LogCategory.GENERAL, !Language.getInstance().hasTranslation("announcement.role." + role.identifier().toTranslationKey())+" < 1");
                Log.info(LogCategory.GENERAL, Language.getInstance().hasTranslation("announcement.role." + role.identifier().getPath())+" < 2");
